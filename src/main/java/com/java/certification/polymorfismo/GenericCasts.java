...
public class GenericCasts {
    ...
    public static void main(String[] args) {
        ...
        ArrayList<NextClass> prueba=new ArrayList<>();
        prueba.add(new NextClass());
        //prueba.add(new BaseClass());

        ArrayList<BaseClass> pruebaF=new ArrayList<>();
        pruebaF.add(new NextClass());
        pruebaF.add(new BaseClass());
